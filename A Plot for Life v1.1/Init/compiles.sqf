...
if (!isDedicated) then {
	...
	fnc_usec_selfActions =			compile preprocessFileLineNumbers "custom\ConvertpUID\fn_selfActions.sqf";		//Checks which actions for self
...
if (!isDedicated) then {
	convertPlayerUID  = compile preprocessFileLineNumbers "custom\ConvertpUID\convertpuid.sqf";
	fnc_usec_damageActions  = compile preprocessFileLineNumbers "custom\ConvertpUID\fn_damageActions.sqf";
	player_updateGui  = compile preprocessFileLineNumbers "custom\ConvertpUID\player_updateGui.sqf";
	player_build  = compile preprocessFileLineNumbers "custom\ConvertpUID\player_build.sqf";
};
